...
## ✍️Tech Stack
[![My Skills](https://skillicons.dev/icons?i=aws,azure,linux,redhat,ubuntu,debian,windows,git,github,bitbucket,gitlab,maven,jenkins,docker,kubernetes,terraform,ansible,elasticsearch,grafana,ai,nginx,py,vscode,wordpress)](https://skillicons.dev)
